      ...
      body: BlocBuilder<AuthBloc, AuthState>(
        builder: (context, authState) {
          if (authState is Authenticated) {
            return BlocBuilder<NutritionBloc, NutritionState>(
              builder: (context, state) {
                if (state is NutritionLoading) {
                  ...
                  return const Center(
                    child: Text('Không có dữ liệu theo dõi nước'),
                  );
                }
              },
            );
            ...
            return const Center(
              child: Text('Vui lòng đăng nhập để theo dõi lượng nước'),
            );
          }
        },
      ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'trên ${(state.targetWaterIntake / 1000).toStringAsFixed(1)}L',
                              style: const TextStyle(
                                fontSize: 16,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _buildTipItem(
                    'Uống nước ngay khi thức dậy để khởi động quá trình trao đổi chất.',
                  ),
                  _buildTipItem(
                    'Mang theo chai nước bên mình suốt cả ngày để dễ dàng uống.',
                  ),
                  _buildTipItem(
                    'Đặt nhắc nhở uống nước đều đặn trong ngày.',
                  ),
                  _buildTipItem(
                    'Ăn các loại thực phẩm giàu nước như trái cây và rau quả để tăng cường hydrat hóa.',
                  ),
                ],
              ),
            ),
