  ...
  void _addMeal() {
    ...
    final MealEntry mealEntry = MealEntry(
      ...
      foodItemId: _selectedFood!.id ??
          '', // Changed to empty string as default (Firebase uses strings)
      foodItem: _selectedFood,
      amount: amount,
    );
              ...
              if (_selectedFood != null) ...[
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText:
                        'Số lượng (${_selectedFood!.servingUnit ?? 'g'})',
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (_selectedFood!.brand != null &&
                      _selectedFood!.brand!.isNotEmpty)
                    Text(
                      _selectedFood!.brand!,
                      style: const TextStyle(
                        color: AppTheme.secondaryTextColor,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildNutrientItem('Calo', calories.toStringAsFixed(0), 'kcal',
                    AppTheme.primaryColor),
                _buildNutrientItem('Protein', protein.toStringAsFixed(1), 'g',
                    AppTheme.secondaryColor),
                _buildNutrientItem('Tinh bột', carbs.toStringAsFixed(1), 'g',
                    AppTheme.accentColor),
                _buildNutrientItem('Chất béo', fat.toStringAsFixed(1), 'g',
                    Colors.purpleAccent),
              ],
            ),
          ],
