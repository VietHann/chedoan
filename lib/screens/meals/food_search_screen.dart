  ...
  Future<void> _loadInitialData() async {
    ...
    try {
      final foodRepository =
          Provider.of<FoodRepository>(context, listen: false);
  ...
  Future<void> _searchFood(String query) async {
    ...
    try {
      ...
      for (var apiItem in apiResults) {
        if (!localResults.any(
            (item) => item.name.toLowerCase() == apiItem.name.toLowerCase())) {
      ...
      if (foodItem.id != null) {
        ...
        setState(() {
          ...
          final int searchIndex =
              _searchResults.indexWhere((item) => item.id == foodItem.id);
          if (searchIndex >= 0) {
          ...
          final int recentIndex =
              _recentItems.indexWhere((item) => item.id == foodItem.id);
          if (recentIndex >= 0) {
