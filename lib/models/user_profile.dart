class UserProfile {
  ...
  factory UserProfile.fromMap(Map<String, dynamic> map) {
    return UserProfile(
      ...
      targetCalories: map['targetCalories'] is int ? map['targetCalories'] : 
                     (map['targetCalories'] is double ? (map['targetCalories'] as double).toInt() : null),
      ...
      targetWater: map['targetWater'] is int ? map['targetWater'] : 
                   (map['targetWater'] is double ? (map['targetWater'] as double).toInt() : null),
    );
  }
